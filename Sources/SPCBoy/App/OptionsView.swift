                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        sectionCard(title: "Playback") {
                            HStack(spacing: 12) {
                                ...
                                TextField("", text: $longPlayTimeText)
                        ...
                        sectionCard(title: "Spectrum") {
                            VStack(alignment: .leading, spacing: 12) {
                                Text("Bars use a vertical gradient from the first color to the second color.")
                                    .font(.system(size: 11))
                                    .foregroundStyle(.secondary)
                                ...
                                HStack(spacing: 16) {
                                    ColorPicker(
                                        "Base",
                                        selection: Binding(
                                            get: { Color(nsColor: model.spectrumGradientStartColor) },
                                            set: { model.spectrumGradientStartColor = NSColor($0) }
                                        ),
                                    ...
                                    ColorPicker(
                                        "Peak",
                                        selection: Binding(
                                            get: { Color(nsColor: model.spectrumGradientEndColor) },
                                            set: { model.spectrumGradientEndColor = NSColor($0) }
                                        ),
                                        supportsOpacity: false
                                    )
                                    .foregroundStyle(.white)
                                    ...
                                    ColorPicker(
                                        "Cap",
                                        selection: Binding(
                                            get: { Color(nsColor: model.spectrumPeakColor) },
                                            set: { model.spectrumPeakColor = NSColor($0) }
                                        ),
                                        supportsOpacity: false
                                    )
                                    .foregroundStyle(.white)
                            ...
                            Toggle(
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    Text("Double-Click Enqueues")
                                        .foregroundStyle(.white)
                                    Text("Double-click only adds items to playlist.")
                                        .font(.system(size: 11))
                                        .foregroundStyle(.secondary)
                                }
                            }
