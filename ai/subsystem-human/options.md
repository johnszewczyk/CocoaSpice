...
- Cache: defaults to on with a 2 GB limit; choose 512 MB, 1 GB, 2 GB, or 4 GB. Cached archive material is pruned least-recently-used after a successful materialization. Cache off uses disposable playback storage, removed when playback stops. Every archive materialization reserves 1 GB of free disk space and refuses material that cannot fit its active storage limit. Clear Cache stops playback and removes cached or disposable archive material; it is unavailable while a library scan is running.
