...
- Route registration has unit coverage. Fixture coverage for standalone and dependent audio, archive playback, malformed tags, and missing libraries remains necessary before a broad NDS library scan.
