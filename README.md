...
- **Database-first library management** — scans run in the background with visible progress and queued requests; Test Links retains moved/missing-file data for fast rediscovery, while Clean Links is the explicit permanent cleanup.
